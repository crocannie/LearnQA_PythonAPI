...
class TestUserAuth:
    def test_auth_user(self):
        ...
        assert "x-csrf-token" in response1.headers, "There is no token in the response"
        ...
        assert user_id_from_auth_method == user_id_from_check_method, "User id from auth not equal to user from check method"
